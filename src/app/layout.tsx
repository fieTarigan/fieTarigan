  ...
  return (
    <html lang="en">
      <body className={leagueSpartan.className}>
        <main className="flex flex-col items-center bg-gray-700 text-white/75">
          <div className="flex flex-col justify-between items-center min-h-screen xl:w-[60%] lg:w-[70%] md:w-[80%] w-[100%]">
            <div className="flex justify-between items-center min-w-[100%] min-h-fit py-4 px-6 text-xl tracking-widest">
              <Link
                href="/"
              ...
              <div className="flex gap-4 items-center">
                <Link href="/experiences" className="pt-1 px-1 rounded-sm transition-colors duration-300 transform hover:bg-gray-500">
                  EXPERIENCES
                </Link>
                <Link href="/projects" className="pt-1 px-1 rounded-sm transition-colors duration-300 transform hover:bg-gray-500">
                  PROJECTS
                </Link>
